...
# Now fit a weighted poisson model

poisson_weighted_recipe <- recipe(score ~ attacker_short_name + home_or_away,
                           data = fixtures_poisson_past,
                           weights = fixtures_poisson_past$weight)
...
# WHY CAN'T I MAKE THIS WORK IN A WORKFLOW?
```

-   Create a table to demonstrate the quality of teams in relation to the model
...
pred_league_table = left_join(home_record, away_record, by = join_by(short_name))|>
  mutate(
